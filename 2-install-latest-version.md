...
The example below is for a pool with 1 Block Producer and 1 Relay Node.
...
If your stake pool has 1 Block Producer and 3 Relay Nodes, here's an example of how you can configure your topology file:
...
cat > $NODE_HOME/${NODE_CONFIG}-topology.json << EOF 
 {
    "Producers": [
      ...
      {
        "addr": "<RELAYNODE2'S IP ADDRESS>",
        "port": 6000,
        "valency": 1
      },
      {
        "addr": "<RELAYNODE3'S IP ADDRESS>",
        "port": 6000,
        "valency": 1
      }
    ]
